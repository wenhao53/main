...
include::../UserGuide.adoc#show-calories-a-person-requires-code-calories-code
...
include::../DeveloperGuide.adoc#314-gender-attribute--current-implementation

include::../DeveloperGuide.adoc#appendix-b-product-scope
