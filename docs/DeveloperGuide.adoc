...
The BMI classification will be adapted from the standards set by the World Health Organisation (WHO). The background colour of the PersonCard for each
...
Each client is saved as a person with weight and height attributes. This is sufficient to facilitate the calculation of their BMI.
...
The background colour of the each client's PersonCard will be updated automatically if there is any change in BMI Classification
...
to the BMI classification (i.e. acceptable, overweight, underweight, obese). Combinations of keywords are acceptable.
