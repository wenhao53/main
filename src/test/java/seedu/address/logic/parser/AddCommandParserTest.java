...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        ...
        assertParseSuccess(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                + HEIGHT_DESC_BOB + WEIGHT_DESC_BOB + GENDER_DESC_BOB + AGE_DESC_BOB
    ...
    public void parse_optionalFieldsMissing_success() {
        ...
        Person expectedPerson = new PersonBuilder().withName(VALID_NAME_AMY).withPhone(VALID_PHONE_AMY)
                ...
                .withWeight(VALID_WEIGHT_AMY).withGender(VALID_GENDER_AMY).withAge(VALID_AGE_AMY).withTags().build();
        assertParseSuccess(parser, NAME_DESC_AMY + PHONE_DESC_AMY + EMAIL_DESC_AMY + ADDRESS_DESC_AMY
                        + HEIGHT_DESC_AMY + WEIGHT_DESC_AMY
                + GENDER_DESC_AMY + AGE_DESC_AMY, new AddCommand(expectedPerson));
    }
    ...
    public void parse_compulsoryFieldMissing_failure() {
        ...
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                        + VALID_HEIGHT_BOB + WEIGHT_DESC_BOB + GENDER_DESC_BOB + AGE_DESC_BOB,
                expectedMessage);

        // missing weight prefix
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                        + HEIGHT_DESC_BOB + VALID_WEIGHT_BOB + GENDER_DESC_BOB + AGE_DESC_BOB,
                expectedMessage);

        // missing gender prefix
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                        + WEIGHT_DESC_BOB + VALID_GENDER_BOB + AGE_DESC_BOB,
                expectedMessage);

        // missing age prefix
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                        + WEIGHT_DESC_BOB  + GENDER_DESC_BOB + VALID_AGE_BOB,
                expectedMessage);
    ...
    public void parse_invalidValue_failure() {
        ...
        // invalid height
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                + INVALID_HEIGHT_DESC + WEIGHT_DESC_BOB + GENDER_DESC_BOB + AGE_DESC_BOB
                + TAG_DESC_HUSBAND + TAG_DESC_FRIEND, Height.MESSAGE_HEIGHT_CONSTRAINTS);

        // invalid weight
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                + HEIGHT_DESC_BOB + INVALID_WEIGHT_DESC + GENDER_DESC_BOB + AGE_DESC_BOB
                + TAG_DESC_HUSBAND + TAG_DESC_FRIEND, Weight.MESSAGE_WEIGHT_CONSTRAINTS);

        // invalid Gender
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                + HEIGHT_DESC_BOB + WEIGHT_DESC_BOB + INVALID_GENDER_DESC + AGE_DESC_BOB
                + TAG_DESC_HUSBAND + TAG_DESC_FRIEND, Gender.MESSAGE_GENDER_CONSTRAINTS);

        // invalid Age
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                + HEIGHT_DESC_BOB + WEIGHT_DESC_BOB + GENDER_DESC_BOB + INVALID_AGE_DESC
